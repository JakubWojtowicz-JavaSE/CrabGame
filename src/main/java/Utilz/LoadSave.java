...
public class LoadSave {
    ...
    public static final String SOUND_B_IMG = "sound_button.png";
    public static final String VOLUME_B_IMG = "volume_buttons.png";
    ...
    public static final String RESUME_RESTART_HOME_B = "urm_buttons.png";
